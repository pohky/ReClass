...
public class FloatNode : BaseNumericNode {
    ...
    public override Size Draw(DrawContext context, int x, int y) => DrawNumeric(context, x, y, IconProvider.Float, "Float", ReadValueFromMemory(context.Memory).ToString("0.000"), null);
